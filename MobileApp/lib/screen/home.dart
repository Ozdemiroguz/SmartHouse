...
class _HomePageState extends State<HomePage> {
  ...
  Widget build(BuildContext context) {
    ...
    // UserProvider üzerinden kullanıcı bilgilerini al
              ...
              children: [
                        ...
                        child: Row(
                          ...
                          children: [
                            Column(
                              ...
                              children: [
                                Text("Welcome ${currentUser?.name}",style: TextStyle(fontSize: 20,color: Colors.white),),
                                SizedBox(height: 10,),
                          ...
                          child: Column(
                            children: [
                              TabBar(
                                ...
                                isScrollable: true,
                                tabs: roomList.map((room) => Tab(child: Text(room.roomName,style:TextStyle(color: Colors.white),),)).toList(),
                              ),
                              Expanded(
               ...
               /* SizedBox(width: screenWidth,
                  ...
                  child: Card(
                    ...
                    color: softBack,
                    elevation: 15,
                    child: Text("More Information Of "),
                  ),
                )*/
